...
var OrderProductStore = /** @class */ (function () {
    ...
    OrderProductStore.prototype.create = function (order) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connection.query(sql, [order.quantity, order.order_id, order.product_id])];
                    case 2:
                        rows = (_a.sent()).rows;
                        connection.release();
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not create product: ".concat(order.product_id, " to order: ").concat(order.order_id, ": ").concat(err_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderProductStore.prototype.index = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var id, connection, sql, rows, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = order.id;
                    ...
                    case 4:
                        err_2 = _a.sent();
                        throw new Error("Error at retrieving products in order: ".concat(id, " ").concat(err_2));
                    case 5: return [2 /*return*/];
                }
            });
        });
    };
    OrderProductStore.prototype.show = function (orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OrderProductStore.prototype.edit = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connection.query(sql, [order.quantity, order.order_id, order.product_id, order.id])];
                    case 2:
                        result = _a.sent();
                        connection.release();
                        return [2 /*return*/, result.rows[0]];
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not update product: ".concat(order.product_id, " in order ").concat(order.order_id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderProductStore.prototype["delete"] = function (orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
...
exports["default"] = OrderProductStore;
