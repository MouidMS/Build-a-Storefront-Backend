...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name_1, price, product, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, productStore.create({ name: name_1, price: price })];
            case 1:
                product = _a.sent();
                res.json({
                    product: product
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, name_2, price, product, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                price = req.body.price;
                return [4 /*yield*/, productStore.update(id, {
                        name: name_2,
                        price: price
                    })];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = parseInt(req.params.id);
                return [4 /*yield*/, productStore["delete"](id)];
            case 1:
                _a.sent();
