...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var firstname, lastname, username, password, user, token, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userStore.show(id)];
            case 1:
                user = _a.sent();
                res.json(user);
                return [3 /*break*/, 3];
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, firstname, lastname, user, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                firstname = req.body.firstname;
                lastname = req.body.lastname;
                return [4 /*yield*/, userStore.update(firstname, lastname, id)];
            case 1:
                user = _a.sent();
                res.json(user);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = parseInt(req.params.id);
                return [4 /*yield*/, userStore["delete"](id)];
            case 1:
                _a.sent();
...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var username, password, u, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 1:
                u = _a.sent();
                if (!u) {
                    return [2 /*return*/, res.status(401).send("Wrong password.")];
                }
